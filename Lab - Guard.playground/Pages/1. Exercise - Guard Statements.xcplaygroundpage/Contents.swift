...
func createUser() -> User? {
    ...
    //Dados válidos - retorna usuario criado
...
//Certificar que o usuario foi criado
if let user = possibleUser {
    print("\(user.firstName) \(user.lastName), tem \(user.age) anos.")
} else {
    print("Favor verificar os dados cadastrados")
}
