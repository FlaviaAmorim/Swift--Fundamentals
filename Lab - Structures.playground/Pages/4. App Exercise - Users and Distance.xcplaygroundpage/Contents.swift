 ...
 */
var myPerson = User(name: "Flavia", age: 27, height: 167, weight: 72, activityLevel: 1)
print("Meu nome é \(myPerson.name). Eu tenho \(myPerson.age)anos. Tenho \(myPerson.height) de altura e peso \(myPerson.weight). O meu nivel de atividade fisica é \(myPerson.activityLevel)")
 ...
 */
let fiveK = Distance(meters: 50000)
print(fiveK.feet)
