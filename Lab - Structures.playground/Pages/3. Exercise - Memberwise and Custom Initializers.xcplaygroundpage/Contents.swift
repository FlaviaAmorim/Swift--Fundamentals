...
var favoriteBook = Book(title: "Divergent", author: "A", pages: 200, price: 130.00)

print("Meu livro favorito é \(favoriteBook.title), que foi escrito por \(favoriteBook.author). O livro tem \(favoriteBook.pages) paginas e custa \(favoriteBook.price)")
