 ...
 */
let walkingChallenges = ["Caminhar por 1 hora", "caminhar 5km"]
let runningChallenges = ["Correr 20km", "Correr 1 hora por dia durante 5 dias"]
...
if challengesUser.isEmpty {
    ...
    print("You have chosen the chalenge \(challenges[0])")
} else {
