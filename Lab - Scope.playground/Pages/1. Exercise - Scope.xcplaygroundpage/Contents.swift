...
//Porque o print da linha 10 utiliza a variavel foo que esta definida dentro do escopo do for, portanto ele nao será encontrado fora desse escopo
/*:
...
let porsch = Car(make: "Porsch", model: "aaa", year: 2000)
